...
require_relative '../src/controllers/controllers'
...
class ControllersTest < Minitest::Test
  ...
  def test_move_snake
    ...
    actual_state = Controllers.move_snake(@initial_state)
  ...
  def test_change_direction_invalid
    ...
    actual_state = Controllers.change_direction(@initial_state, Model::Direction::UP)
    assert_equal actual_state, expected_state
  end
  ...
  def test_change_direction_valid
    ...
    actual_state = Controllers.change_direction(@initial_state, Model::Direction::LEFT)
    assert_equal actual_state, expected_state
  end
